...
procedure Paralel_Travelers is
  ...
  begin
   ...
   Board : array (0 .. Board_Width - 1, 0 .. Board_Height - 1) of Cell_Lock;
  ...
  task body Traveler_Task_Type is
   ...
   begin
    accept Init (Id : Integer; Seed : Integer; Symbol : Character) do
      Reset (G, Seed);
      Traveler.N      := Integer (Float'Floor (4.0 * Random (G)));
      Traveler.Id     := Id;
    ...
    for Step in 0 .. Nr_of_Steps loop
      ...
      begin
        ...
        loop
          ...
          select
            Board(New_Pos.X,New_Pos.Y).Acquire;
